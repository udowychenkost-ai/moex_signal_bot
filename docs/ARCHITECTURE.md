...
| `app/provider_health.py` | Gemini ListModels startup/runtime health, DB telemetry summary, Telegram-safe diagnostics | Остановка ingestion/scheduler и вывод API key |
